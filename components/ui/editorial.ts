export const editorialSpacing = {
  sectionStack: "flex flex-col gap-[var(--space-12)]",
  sectionHeaderStack:
  ...
  heroShell: "overflow-hidden pt-[calc(var(--space-20)+var(--space-16))]",
  heroStack: "flex flex-col gap-[var(--space-12)]",
  heroGrid: "grid gap-[var(--space-12)] lg:items-end",
